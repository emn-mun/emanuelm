document.addEventListener('DOMContentLoaded', () => {
    ...
    const professionalExperience = [
        ...
        },
        {
            ...
            description: "Pioneered the architecture and initial development of a new e-commerce app for Durstexpress, focusing on scalable design, modularisation, and robust development processes. Established CI/CD pipelines and team guidelines to ensure maintainability, efficiency, and high code quality from the ground up.",
            tasks: [
        ...
        },
        {
            ...
            description: "Kickstarted the the rebrading and redesign process of all iOS apps owned by the OLX Group. As a leader in the e-commerce space, at the time OLX had 11 apps available in 6 markets centered around classifieds ads, auto and real estate",
            tasks: [
            ...
            skills: ["Swift", "UIKit", "Core Location", "Alamofire"],
            media: [
                { type: 'image', src: 'assets/olx.webp' }
            ]
        },
        {
            ...
            description: "Worked on several high-profile marketplace apps under the eBay umbrella (now Adevinta), including Kijiji and eBay, focusing on feature development, UI modernization, and performance optimization.",
            tasks: [
        ...
        },
        {
            ...
            media: [
                { type: 'image', src: 'assets/xing.webp' }
            ]
        },
        {
            title: "iOS Developer",
            ...
            description: "Developed innovative prototype apps for e-commerce clients, leveraging beacon technology and augmented reality. Enhanced app quality and user satisfaction by introducing A/B testing, crash reporting, analytics, and remote configuration.",
            tasks: [
            ...
            skills: ["Swift", "UIKit", "Realm", "REST APIs"],
            media: [
                { type: 'image', src: 'assets/novomind.jpg' }
            ]
        },
        {
    ...
    const sideProjects = [
        {
            ...
            description: "An innovative iOS Keyboard Extension that provides real-time translation, allowing users to type in one language and have it instantly appear in another. The app supports over 20 languages and works seamlessly across all applications.",
            tasks: [
        ...
        {
            title: "Snaps Search",
            description: "Snaps Search is a privacy-focused macOS app that lets you extract text from screenshots using Apple Vision OCR and organize them for easy search. You can ask questions about your images using a local BERT model, and all processing happens on your device—no data is sent to any server or third party.",
            tasks: [
            ...
            media: [
                 { type: 'image', src: 'assets/snapssearch.png' }
            ]
        },
        {
            title: "Block Ads",
            description: "A content blocker for Safari on iOS and macOS. It uses a curated and frequently updated list of blocking rules to remove ads, trackers, and other annoyances, leading to a faster and cleaner browsing experience.",
            tasks: [
            ...
            media: [
                { type: 'image', src: 'assets/BlockAds.webp' }
            ]
        }
    ];
    ...
    const skills = {
        ...
        "Frameworks & Libraries": ["SwiftUI", "UIKit", "Combine", "Core Data", "Core Location", "Core Animation", "XCTest", "Composable Architecture (TCA)", "Alamofire", "Sendbird SDK"],
    ...
    function createCard(item, type) {
        ...
        if (needsTruncation) {
            listHtml = listItems.slice(0, limit).map(task => `<li>${task}</li>`).join('');
        } else {
